...
import { PUBLIC_AWS_REGION as AWS_REGION, PUBLIC_AWS_REGION } from '$env/static/public'

const issuer = `https://cognito-idp.${AWS_REGION}.amazonaws.com/${AWS_COGNITO_USER_POOL_ID}`
